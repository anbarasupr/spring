...
public class LoggingHandler {
	...
	public void logBefore(JoinPoint joinPoint, HttpServletRequest request) {
		...
		log.debug("@Before Entering in Method :  " + joinPoint.getSignature().getName());
		...
		if (null != request) {
			...
			log.debug("@Before End Header Section of request ");
		}
	}
	...
	public void logAfter(JoinPoint joinPoint, Object returnValue) {
		log.debug("@AfterReturning Method Return value : " + returnValue);
	}
	...
	public void logAfterThrowing(JoinPoint joinPoint, Throwable exception) {
		log.error("@AfterThrowing An exception has been thrown in " + joinPoint.getSignature().getName() + " ()");
		log.error("@AfterThrowing Cause : " + exception.getCause());
	}
	...
	public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		try {
			...
			log.debug("@Around Method " + className + "." + methodName + " ()" + " execution time : "
					+ elapsedTime + " ms");
